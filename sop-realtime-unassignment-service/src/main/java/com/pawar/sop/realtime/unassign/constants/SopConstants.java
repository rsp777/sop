package com.pawar.sop.realtime.unassign.constants;

public interface SopConstants {
	public static final String ELIGIBLE_LOCATIONS_MODULE = "Eligible Locations module";
	public static final String UNASSIGN = "UNASSIGN";
	public static final String REALTIMEUNASSIGN = "REALTIMEUNASSIGN";
	public static final String ASSIGN = "ASSIGN";
	public static final String REALTIMEASSIGN = "REALTIMEASSIGN";
	public static final String SERVICE_NAME = "realtime-unassignment-service";
	public static final String NEW_BATCH = "New batch started: ";
	public static final String TRIGGERED = " triggered for item : %s of category: %s";
