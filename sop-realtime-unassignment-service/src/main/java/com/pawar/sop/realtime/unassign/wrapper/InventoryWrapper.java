package com.pawar.sop.realtime.unassign.wrapper;
...
import com.pawar.sop.realtime.unassign.config.AsnServiceConfiguration;
import com.pawar.sop.realtime.unassign.config.InventoryServiceConfiguration;
...
//	}
	...
	public InventoryWrapper(AsnServiceConfiguration asnServiceConfiguration,
			InventoryServiceConfiguration inventoryServiceConfiguration, HttpService httpService) {
...
//			logger.info("Response Body : {}", response.getBody());
	...
	public List<Inventory> fetchActiveInventoryByItemName(String itemName) throws JsonMappingException, JsonProcessingException {
	...
	public List<Inventory> fetchActiveInventory(String locnBrcd) throws JsonMappingException, JsonProcessingException {
